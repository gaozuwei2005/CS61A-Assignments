class Account:
    ...
    def time_to_retire(self, amount):
        ...
        "*** YOUR CODE HERE ***"
        virBalance = self.balance
        year = 0
        while virBalance < amount:
            virBalance *= self.interest + 1
            year += 1
        return year
...
def duplicate_link(s, val):
    ...
    if s == Link.empty:
        ...
        return Link(val, Link(val, duplicate_link(s.rest, val)))
    else:
        return Link(val, duplicate_link(s.rest, val))
